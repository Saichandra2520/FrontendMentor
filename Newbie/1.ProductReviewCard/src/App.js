  ...
  return (
    <div className="App">
      <div className="container">
        <div className="left" >
          <img id="proimg" src={mobileimg} alt="product" />
        </div>
        <div className="right">
          <h2>PERFUME</h2>
          <h1>Gabrielle
      ...
      <div class="attribution"><h5>
    Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank">Frontend Mentor</a>. 
    Coded by <a href="https://www.linkedin.com/in/vallakatla-sai-chandra-1b0093206/" target="_blank">Sai Chandra</a>.</h5>
  </div>
    </div>
  );
}
